...
public class AdminController {
  ...
  public ResponseEntity createUser(@RequestBody VehicleDTO vehicleDTO) throws Exception {
  ...
  public ResponseEntity updateUser(@RequestBody VehicleDTO vehicleDTO, @PathVariable("id") int id) {
